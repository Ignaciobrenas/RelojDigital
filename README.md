...
Salida por pantalla
Muestra el tiempo como H H : M M, por ejemplo 09:07 o 23:59.
...
Inicializa el reloj (00:00).
Muestra la hora actual.
Presenta el menú.
Ejecuta la acción seleccionada.
Repite hasta que el usuario pulse 0 (Salir).
...
Shell# Compilarjavac RelojDigital.java# Ejecutarjava com.mycompany.Actividades_Ignacio.RelojDigitalMostrar más líneas

Nota: Asegúrate de mantener la estructura de paquetes (package com.mycompany.Actividades_Ignacio;).
Si ejecutas fuera de esa estructura, puedes quitar la línea package o compilar/ejecutar respetando el árbol de directorios.


🚀 Mejoras propuestas (siguientes iteraciones)

Entrada de hora inicial por teclado (validada, p. ej. HH:MM).
Formato con ceros siempre visibles (String.format("%02d:%02d", ... )) en vez de concatenar dígitos.
Tests unitarios (JUnit) para casos límite (23:59→00:00, 00:00→23:59, etc.).
Modo 12h con indicador AM/PM.
Temporizador (tick automático) usando ScheduledExecutorService para simular el paso del tiempo real.


📂 Archivos de la entrega

RelojDigital.java – Implementación del reloj y menú.
